...
class StockListing {
  static const List<String> indexes = ['symbol', 'name', 'exchange', 'assetType', 'ipoDate', 'delistingDate', 'status'];
  String symbol;
  String name;
  String exchange;
  String assetType;
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
          other is StockListing && runtimeType == other.runtimeType &&
              symbol == other.symbol && name == other.name &&
              exchange == other.exchange && assetType == other.assetType &&
              ipoDate == other.ipoDate &&
              delistingDate == other.delistingDate && status == other.status;

  @override
  int get hashCode =>
      symbol.hashCode ^ name.hashCode ^ exchange.hashCode ^ assetType
          .hashCode ^ ipoDate.hashCode ^ delistingDate.hashCode ^ status
          .hashCode;
