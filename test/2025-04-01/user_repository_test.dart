...
class MockUserDataSource implements UserDataSource {
  ...
  Future<List<Map<String, dynamic>>> fetchUsers(String path) async {
    return mockJsonUsers;
  }
}

void main() {
  UserDataSource mockUserDataSource = MockUserDataSource();
  UserRepository userRepository = UserRepositoryImpl(
    userDataSource: mockUserDataSource,
  );

  group('User Repository 테스트', () {
    test('getUsers() -> 정상적으로 사용자들을 반환해야함', () async {
      final mockUsers =
          MockUserDataSource.mockJsonUsers
    ...
    test('getUsersTop10ByUserName() -> 열 명의 사용자들을 반환해야 한다.', () async {
      final mockUsers = MockUserDataSource.mockJsonUsers
          .map((e) => User.fromJson(e))
          .toList()
